...
!===> ...  begin here
      ...
      !$ser verbatim xponbl=-dldtl/con_rv+heatl/(con_rv*con_ttp)
      !$ser verbatim dldti=con_cvap-con_csol
      !$ser verbatim heati=con_hvap+con_hfus
...
! in  mfshalcnv,  'cnvw' and 'cnvc' are set to zero before computation starts:
          ...
          elseif (Model%imfshalcnv == 3) then
            ...
            !$ser verbatim do k = 1, Model%ntrac-Model%ncld+2
              !$ser verbatim print *, 'INFO: Model fscav: ',Model%fscav(k)
              !$ser verbatim print *, 'INFO: array fscav: ',ser_fscav(k)
              !$ser verbatim ser_fscav(k) = Model%fscav(k)
            !$ser verbatim enddo
