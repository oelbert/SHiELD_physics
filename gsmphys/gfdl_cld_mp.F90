...
subroutine mpdrv (hydrostatic, ua, va, wa, delp, pt, qv, ql, qr, qi, qs, qg, &
    ...
    !$ser verbatim real, dimension (is:ie, ks:ke) :: ws_qvo, ws_qlo, ws_qro, ws_qio, ws_qso, ws_qgo, ws_ccno, ws_pto, ws_tin, ws_qsat, ws_dqdt, ws_dqh, ws_bool_check
...
!$ser verbatim ws_qvo (i, :), ws_qlo (i, :), ws_qro (i, :), ws_qio (i, :), ws_qso (i, :), ws_qgo (i, :), ws_ccno (i, :), ws_pto (i, :), ws_tin (i, :), ws_qsat (i, :), ws_dqdt (i, :), ws_dqh (i, :), ws_bool_check (i, :),&
...
!$ser verbatim szs_condo (i), szs_depo (i), szs_reevapo (i), szs_subo (i), szs_lcpk (i, :), szs_icpk (i, :), szs_tcpk (i, :), szs_tcp3 (i, :), szs_lcpko (i, :), szs_icpko (i, :), szs_tcpko (i, :), szs_tcp3o (i, :), szs_cvm (i, :), szs_cvmo (i, :),&
    ...
    !$ser data ws_tin=zerobuff_3d ws_qsat=zerobuff_3d ws_dqdt=zerobuff_3d ws_dqh=zerobuff_3d ws_bool_check=zerobuff_3d
    ...
    !$ser data ws_tin=ws_tin ws_qsat=ws_qsat ws_dqdt=ws_dqdt ws_dqh=ws_dqh ws_bool_check=ws_bool_check
...
!$ser verbatim ws_qvo, ws_qlo, ws_qro, ws_qio, ws_qso, ws_qgo, ws_ccno, ws_pto, ws_tin, ws_qsat, ws_dqdt, ws_dqh, ws_bool_check,&
...
!$ser verbatim szs_condo, szs_depo, szs_reevapo, szs_subo, szs_lcpk, szs_icpk, szs_tcpk, szs_tcp3, szs_lcpko, szs_icpko, szs_tcpko, szs_tcp3o, szs_cvm, szs_cvmo,&
    ...
    !$ser verbatim real, intent (inout), dimension (ks:ke) :: ws_qvo, ws_qlo, ws_qro, ws_qio, ws_qso, ws_qgo, ws_ccno, ws_pto, ws_tin, ws_qsat, ws_dqdt, ws_dqh, ws_bool_check
...
!$ser verbatim ws_reevap, ws_reevapo, n, ws_tin, ws_qsat, ws_dqdt, ws_dqh, ws_bool_check,&
...
!$ser verbatim ws_qv, ws_ql, ws_qr, ws_qi, ws_qs, ws_qg, ws_ccn, ws_pt,&
!$ser verbatim ws_qvo, ws_qlo, ws_qro, ws_qio, ws_qso, ws_qgo, ws_ccno, ws_pto,&
!$ser verbatim ws_reevap, ws_reevapo, nn, ws_tin, ws_qsat, ws_dqdt, ws_dqh, ws_bool_check,&
        den, denfac, vtw, vtr, ccn, rh_rain, h_var, reevap)
...
!$ser verbatim ws_tin, ws_qsat, ws_dqdt, ws_dqh, ws_bool_check,&
